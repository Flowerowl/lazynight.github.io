...
为了提高各位的英语水平，具体内容没有翻译。（众人：你又在为你的懒惰找借口……）<section> 

## 特别注意 {#section--c!100-projects-by-martyr2--.E7.89.B9.E5.88.AB.E6.B3.A8.E6.84.8F}
...
*   「类型抽象」分类下的题目，如果不是传统 OOP 语言，可以略去不做</section> <section> 

## 数学 {#section--c!100-projects-by-martyr2--.E6.95.B0.E5.AD.A6}
...
**Dijkstra’s Algorithm** – Create a program that finds the shortest path through a graph using its edges.</section> <section> 

## 文字 {#section--c!100-projects-by-martyr2--.E6.96.87.E5.AD.97}
...
**Regex Query Tool** – A tool that allows the user to enter a text string and then in a separate control enter a regex pattern. It will run the regular exp**ression against the source text and return any matches or flag errors in the regular exp**ression.</section> <section> 

## 网络 {#section--c!100-projects-by-martyr2--.E7.BD.91.E7.BB.9C}
...
**Web Bot** – An automated program which carries out tasks on the web including checking websites, page scraping, and summarization of data or web posting.</section> <section> 

## 类型抽象 {#section--c!100-projects-by-martyr2--.E7.B1.BB.E5.9E.8B.E6.8A.BD.E8.B1.A1}
...
**Family Tree Creator** – Create a class called “Person” which will have a name, when they were born and when (and if) they died. Allow the user to create these Person classes and put them into a family tree structure. Print out the tree to the screen.</section> <section> 

## 并发 {#section--c!100-projects-by-martyr2--.E5.B9.B6.E5.8F.91}
...
**Bulk Thumbnail Creator** – Picture processing can take a bit of time for some transformations. Especially if the image is large. Create an image program which can take hundreds of images and converts them to a specified size in the background thread while you do other things. For added complexity, have one thread handling re-sizing, have another bulk renaming of thumbnails etc.</section> <section> 

## 网页 {#section--c!100-projects-by-martyr2--.E7.BD.91.E9.A1.B5}
...
## 文件 {#section--c!100-projects-by-martyr2--.E6.96.87.E4.BB.B6}
...
**Versioning Manager** – Create your own versioning system for code files. Users are forced to check out items and lock items during reading and writing so that a group of programmers are not accidentally overwriting code files on one another.</section> <section> 

## 数据库 {#section--c!100-projects-by-martyr2--.E6.95.B0.E6.8D.AE.E5.BA.93}
...
**Web Board (Forum)** – Create a forum for you and your buddies to post, administer and share thoughts and ideas.</section> <section> 

## 图形与媒体 {#section--c!100-projects-by-martyr2--.E5.9B.BE.E5.BD.A2.E4.B8.8E.E5.AA.92.E4.BD.93}
...
转载自：<http://typeof.net/c/100-projects-by-martyr2.html></section> 

转载请注明：[于哲的博客][2] &raquo; [Martyr2 的一百个大作业][3]

 [1]: http://www.dreamincode.net/forums/topic/78802-martyr2s-mega-project-ideas-list/
 [2]: http://localhost/wordpress
 [3]: http://localhost/wordpress/2937.html